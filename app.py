...
def process_image():
    ...
    temp_path = './../dataset/test/img.jpg'
    ...
    def visualize_result(image_dir, caption, output_path):
        ...
        output_path = os.path.join('static', 'output_img_demo', f'{image_ids}')
    ...
    # Get the selected theme from the form data
    selected_theme = request.form.get('theme', 'uit_viic')

    # Load the corresponding model and vocabulary files based on the selected theme
    model_path = f'./../model/MDSANet_best_CLIP_{selected_theme}.pth'
    vocab_path = f'./vocab_{selected_theme}.pkl'
    ...
    #model_path = './../model/MDSANet_best_CLIP_viecap4h.pth'
    ...
    output_folder = './static/output_img_demo'
    ...
    for image_name in tqdm(image_ids):
        ...
        img_path  = visualize_result(img_path, gen_i, output_folder)
